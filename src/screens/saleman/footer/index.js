...
import {
  ...
  selectPage(value){
    ...
    switch(value){
      case 0 :
        this.handleOnpress('SaleHome');
        break;
      case 1:
        this.handleOnpress('MyPerf');
        break;
      case 2:
        this.handleOnpress('MyClient');
        break;
      case 3:
        this.handleOnpress('Sale_Menu');
        break;
    }
  }
  ...
  render(){
        return (
          ...
          <BottomNavigation
            ...
            <BottomNavigationTab title='my perf' icon={(style)=>{return (<Icon { ...style } name='shopping-bag-outline'/>)}}/>
